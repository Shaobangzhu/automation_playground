...
def format_car(car):
    ...
    return "{} {} ({})".format(
        car["car_maker"], car["car_model"], car["car_year"])
...
def process_data(data):
    ...
    for item in data:
        ...
        if item_revenue > max_revenue["revenue"]:
            ...
            max_revenue = item 
        # TODO: also handles max sales
        if item["total_sales"] > sales["total_sales"]:
            sales = item 
        # TODO: also handles most popular car_year
...
def main(argv):
    ...
    report("../files/car.pdf", "Cars report", new_summary, cars_dict_to_table(data))
    # TODO: send the PDF report as an email attachment
    msg = email_generate("andyluloveusc@gmail.com", "luchaora@outlook.com",
                         "Sales summary for last month", new_summary, "../files/car.pdf")
    email_send(msg)
